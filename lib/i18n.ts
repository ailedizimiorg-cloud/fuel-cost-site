...
export const translations: { [key: string]: any } = {
  en: {
    ...
    distanceTo: "Distance to {city} (km)",
  ...
  tr: {
    ...
    distanceTo: "{city} yönüne olan mesafe (km)",
  ...
  de: {
    ...
    distanceTo: "Entfernung nach {city} (km)",
  ...
  fr: {
    ...
    distanceTo: "Distance vers {city} (km)",
  ...
  es: {
    ...
    distanceTo: "Distancia a {city} (km)",
  ...
  it: {
    ...
    distanceTo: "Distanza da {city} (km)",
